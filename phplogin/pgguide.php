...
<body class="navbarh">
  ...
  <button type="button" class="btn back-button" onclick="window.location.href='pgfront.php'">Back</button> <!-- Back button inside navbar -->
</div>
...
<?php // Start the session
  ...
  ?>
        ...
        <button type="button" class="btn btn-custom" onclick="window.location.href='pglogin.php'">Next</button>
				</div>
