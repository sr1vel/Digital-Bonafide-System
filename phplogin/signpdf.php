...
if (isset($_POST['rollnumber'])) {
    ...
    if ($result->num_rows > 0) {
        ...
        // Initialize the CustomPDF class
        ...
        $imagePathLeft = "https://srec.ac.in/ABMDB2023/SNR.jpg"; 
        $pdf->Image($imagePathLeft, 10, 27, 40, 30); 

        // Add the second image to the top right
        $imagePathRight = "https://srec.ac.in/uploads/resource/src/8yeEAIUofd01022018043456srec-logo.jpg"; 
       ...
       &nbsp; &nbsp; &nbsp; &nbsp;<table>
        ...
        $pdf->Image($imagePathRight, $pdf->getPageWidth() - 55, 227, 45, 45); 
