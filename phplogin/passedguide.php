...
<body class="navbarh">
  ...
  <button type="button" class="btn back-button" onclick="window.location.href='passedfront.php'">Back</button> <!-- Back button inside navbar -->
</div>
...
<?php // Start the session
  ...
  ?>
		...
		<div class="container">
		<h1>GUIDELINES</h1>
        <p>1.Students must enter the  valid email id of their respective Headofthe department.</p>
        ...
        <p>6.Enter the valid reasons , which is going to printed in your certificate.</p>
        <button type="button" class="btn btn-custom" onclick="window.location.href='passed.php'">Next</button>
				</div>
