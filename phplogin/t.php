...
if (isset($_SESSION['username'])) {
    ...
    $sql = "SELECT * FROM tutor WHERE tmail = '$username' OR atmail = '$username'";
...
if (isset($_POST["Hosteltutor_$rollnumber"]) && !isCheckboxFilled($rollnumber, 'Hosteltutor')) {
    ...
    $conn->query($sql);
        ...
        if (isCheckboxFilled($rollnumber, 'Tutor')) {
        ...
        <div class="top-menu">
            <div class="container">
                <div class="row">
                    ...
                    <div class="goBack">
                        <button onclick="window.location.href='tutorafterlogin.php'">Home</button>
                    </div>
                    <div class="logout">
