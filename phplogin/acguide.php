...
<body class="navbarh">
  ...
  <button type="button" class="btn back-button" onclick="window.location.href='acafterlogin.php'">Back</button> <!-- Back button inside navbar -->
</div>
...
<?php // Start the session
  ...
  ?>
		...
		<div class="container">
		<h1>GUIDELINES</h1>
        <p>1.Academic coordinator should approve ONLY AFTER THE TUTOR VERIFIED!!.</p>
        <p>2.Download and verify the id proof of the student and check with details.</p>
		<p>3.The Scholarship avail students cannot apply for the bonafide.</p>
        <p>4.The 7.5 Reservation students cannot apply for the bonafide.</p>
        <p>5.Check with the reasons for the applications for the bonafide certificate</p>
        <button type="button" class="btn btn-custom" onclick="window.location.href='ac1.php'">Next</button>
				</div>
