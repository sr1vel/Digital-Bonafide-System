...
<html lang="en">
  <head>
    ...
    <style>
      ...
      *:after {
      ...
      body {
        ...
        background: #fff; /* Changed background color to blue */
      }
      .msg {
    z-index: 1;
    position: relative;
    ...
    overflow: hidden;
    position: absolute;
    left: 640px; /* Adjust if necessary */
    top: 0;
   ...
   /* Adjust if necessary */
      ...
      .img {
        ...
        height: 100%;
        padding-top: 360px;
        background: #092a47; /* Changed background color to blue */
      }
    ...
    margin-top: 40px;
    margin-bottom: 20px;
    background: #092a47; /* Static background color */
    text-transform: uppercase;
...
.submit:hover {
    background: #092a47; /* Keep the background color the same on hover */
