...
<head>
  ...
  <style>
    ...
    .logout button:hover {
      background-color:  #206aab !important; /* Darker red hover color */
      border-color:  #206aab !important; /* Matching hover border color */
      color:#ffffff
    }
  </style>
</head>
...
?>
  <div class="card">
    <div class="text">
      ...
      <button onclick="window.location.href ='hosteltutor1.php';">View</button>
    </div>
  </div>
