...
try {
    ...
    $stmtUg = $pdo->prepare("SELECT course, year, reason, Date, rollnumber FROM uganalysis");
    $stmtUg->execute();
    $ugData = $stmtUg->fetchAll(PDO::FETCH_ASSOC);
