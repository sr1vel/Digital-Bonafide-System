...
if (isset($_POST['rollnumber'])) {
    ...
    if ($result->num_rows > 0) {
        ...
        * {
        ...
        <div></div>
      <p> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;The following expenses will be incurred during $year of $b course($Years-$YearsIncremented).</p>
        <h3></h3>
        &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;<table>
            &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;<tr>
        ...
        &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;</table>
        <br>
         <p> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;This certificate is issued to enable $m to apply for <strong>$reason</strong> on their $g request.</p>
        ";
