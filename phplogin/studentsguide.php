...
<body class="navbarh">
  ...
  <button type="button" class="btn back-button" onclick="window.location.href='stuafterlogin.php'">Back</button> <!-- Back button inside navbar -->
</div>
...
<?php // Start the session
  ...
  ?>
		...
		<div class="container">
		<h1>GUIDELINES</h1>
        <p>1.Students must enter the  valid email id of their respective tutors, AcademicCoordinator,Headofthe department.</p>
        <p>2.Students applied bonafide certificate before for educational loan cannot apply twice.Only once in a year is acceptable.</p>
		<p>3.The status of the verification can be tracked done by the students</p>
        <p>4.While giving the details of the mail ids please be sure so that the given mailid is going to recieve your request.</p>
        <p>5.Once you recieve the mail from the admin office you can collect the certificate from the adminstartion</p>
        <p>6.Students with 7.5 RESERVATION,WHO AVAILED SCHOLARSHIP cannot apply for EDUCATIONAL LOAN.</p>
        <p>7.Enter the valid reasons , which is going to printed in your certificate.</p>
        <button type="button" class="btn btn-custom" onclick="window.location.href='ug.php'">Next</button>
				</div>
