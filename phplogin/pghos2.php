...
if (isset($_POST['rollnumber'])) {
    ...
    if ($result->num_rows > 0) {
        ...
        $sql_fee = "SELECT `Tuition_Fee`, `Miscellaneous_Fee`, `Total_Fee` FROM iindpg WHERE rollnumber = '$rollnumber'";
        ...
        if ($result_fee->num_rows > 0) {
            ...
            <tr>
                ...
                <td style='text-align: right;'><strong>{$row_fee['Total_Fee']}</strong></td>
            </tr>";
        } else {
            $fee_structure = "
            <tr>
...
<h3><strong>HOSTEL FEE STRUCTURE</strong></h3>
<table>
<tr>
    <th><strong>Particulars</strong></th>
    <th><strong>II YEAR (INR)</strong></th>
</tr>"
;
