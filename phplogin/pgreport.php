...
try {
    ...
    $stmtPg = $pdo->prepare("SELECT course, year, reason, Date, rollnumber FROM pganalysis");
    $stmtPg->execute();
    ...
    $stmtPassed = $pdo->prepare("SELECT course, reason, rollnumber, Date FROM rejectionpg");
    $stmtPassed->execute();
