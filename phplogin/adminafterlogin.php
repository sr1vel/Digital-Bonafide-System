    ...
    <div class="card-container">
      <div class="card">
        <div class="text">
          ...
          <button onclick="window.location.href ='sampleadmin.php';">View</button>
        </div>
      </div>
      <div class="card">
        <div class="text">
          <h2 data-splitting="">PG Applicants</h2>
          <button onclick="window.location.href ='adminpg.php';">View</button>
        </div>
      </div>
      <div class="card">
        <div class="text">
          <h2 data-splitting="">Passedout Applicants</h2>
          <button onclick="window.location.href ='adminpassed.php';">View</button>
        </div>
      </div>
      <div class="card">
        <div class="text">
          <h2 data-splitting="">Analysis</h2>
          <button onclick="window.location.href ='statistics1.php';">View</button>
        </div>
      </div>
    </div>
  </div>
