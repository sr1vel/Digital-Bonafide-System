...
if (isset($_SESSION['username'])) {
    ...
    $sql = "SELECT * FROM htutor WHERE htmail = '$username'";
...
if (isset($POST["Hosteltutor$rollnumber"]) && !isCheckboxFilled($rollnumber, 'Hosteltutor')) {
    ...
    $conn->query($sql);
        ...
        if (isCheckboxFilled($rollnumber, 'Hosteltutor')) {
            // Delete data from the hod table
            $delete_sql = "DELETE FROM  htutor WHERE rollnumber = '$rollnumber'";
        ...
        <div class="top-menu">
            <div class="container">
                <div class="row">
                    ...
                    <div class="goBack">
                        <button onclick="window.location.href='hostelafterlogin.php'">Home</button>
                    </div>
                    <div class="logout">
  ...
  xhr.onreadystatechange = function() {
    if (xhr.readyState === 4 && xhr.status === 200) {
      ...
      if (xhr.responseText.trim() === 'success') {
        ...
        window.location.href = 'hosteltutor.php'; // Redirect to login page
      } else {
